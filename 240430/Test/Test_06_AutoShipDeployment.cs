...
public class Test_06_AutoShipDeployment : Test_05_ShipDeployment
{
    ...
    void AutoShipDeployment()
    {
        ...
        /////////////////////////////////////// 내가 작성한 코드
        //Vector2Int grid = RandomGridPosition();
        //for (int i = 0; i < testShips.Length; i++)
        //{
        //    board.ShipDeployment(testShips[i], grid);
        //}
    }
...
/// 실습_240430
/// 1. reset 버튼을 누르면 배치되어있는 모든 배가 배치 해제된다.
/// 2. random 버튼을 누르면 아직 배치되지 않은 모든 배가 자동으로 배치된다.
...
//            for (int x = 0; x < 11; x++)
//            {
//                Vector3 world = board.GridToWorld(x, y);
//                result = board.WorldToGrid(world);
//            }
//        }
//    }
...
//    // 우선 순위가 높은 위치에서 result를 true로 만들기
//    for (int y = 1; y < 10; y++)
//    {
//        for (int x = 1; x < 10; x++)
//        {
