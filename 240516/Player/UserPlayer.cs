...
public class UserPlayer : PlayerBase
{
    ...
    /// </summary>
    /// <param name="_">사용 안함. 마우스 커서의 스크린 좌표</param>
    ...
    private void OnMouseClick(Vector2 position)
    {
        ...
        {
            // 선택된 배가 있다.
                // 배치할 수 있으면 배치하고 선택된 배 null로 만들기
            // 선택된 배가 없다.
                // 클릭한 곳에 배가 있으면 그 배를 배치 취소
            ...
            else
            {
                ...
                ShipType shipType = board.GetShipTypeOnBoard(grid); // 클릭된 지점에 함선이 있는지 확인
