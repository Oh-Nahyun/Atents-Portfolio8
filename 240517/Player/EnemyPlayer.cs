...
public class EnemyPlayer : PlayerBase
{
    ...
    protected override void Start()
    {
        ...
        thinkingTimeMax = Mathf.Min(thinkingTimeMax, turnController.TurnDuration); // 최대 대기 시간 설정 (TurnDuration보다 작거나 같아야 한다.)
    }
    ...
    {
        StopAllCoroutines(); // 타임아웃일 때 코루틴 실행되는 것 방지
...
/// 실습_240509
/// 턴을 시작하면 랜덤한 시간(thinkingTimeMin ~ thinkingTimeMax) 후에 자동 공격을 한다. (코루틴)
