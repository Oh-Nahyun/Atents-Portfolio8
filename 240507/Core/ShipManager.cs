...
public class ShipManager : Singleton<ShipManager>
{
    ...
    public void SetDeployModeColor(bool isSuccess)
    {
        ...
        {
            DeployModeShipMaterial.SetColor(BaseColor_ID, SuccessColor);
        }
        else
        {
            DeployModeShipMaterial.SetColor(BaseColor_ID, FailColor);
        }
    }
}
